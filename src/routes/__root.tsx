...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Willian Stumm Martin — Gestor Financeiro Social e Empresarial" },
      ...
      { name: "twitter:title", content: "Willian Stumm Martin — Gestor Financeiro Social e Empresarial" },
