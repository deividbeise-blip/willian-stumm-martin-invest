...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Willian Martin Stumm — Gestor Financeiro Social e Empresarial" },
      ...
      { name: "twitter:title", content: "Willian Martin Stumm — Gestor Financeiro Social e Empresarial" },
