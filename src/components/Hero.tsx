  ...
  return (
    <section ref={ref} id="início" className="relative h-screen w-full overflow-hidden bg-background">
      ...
      <motion.div style={{ opacity }} className="relative z-10 h-full flex flex-col items-center justify-center px-6 text-center">
        ...
        >
          {[
            { label: "WhatsApp", href: "https://wa.me/5551997093672?text=Quero%20organizar%20minha%20vida%20financeira%20Willian", icon: (
            ...
            { label: "YouTube", href: "https://www.youtube.com/@JovemdeValor-WillianMartin", icon: (
            ...
            { label: "TikTok", href: "https://www.tiktok.com/@jovemdevalor_investir", icon: (
